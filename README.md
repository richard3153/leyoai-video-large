# 🎬 LeyoAI Video Safety Assistant (Large)
...
**LeyoAI Video Safety Assistant (Large)** — Part of the [LeyoAI](https://leyoai.vercel.app) platform by 杭州市上城区乐友信息服务工作室.
...
model = PeftModel.from_pretrained(base, "richard3153/leyoai-video-large")
model.eval()
...
Also available: [FFZwai/leyoai-video-large](https://huggingface.co/FFZwai/leyoai-video-large)
...
**LeyoAI 视频安全助手（大型版）** — [杭州市上城区乐友信息服务工作室](https://leyoai.vercel.app)旗下 [LeyoAI](https://leyoai.vercel.app) 平台。
...
也可在 HuggingFace 获取：[FFZwai/leyoai-video-large](https://huggingface.co/FFZwai/leyoai-video-large)
